...
from visionlab_stack.detection.yolov5.models.yolo import Model
from visionlab_stack.detection.yolov5.utils.general import set_logging
from visionlab_stack.detection.yolov5.utils.google_utils import attempt_download
...
def create(name, pretrained, channels, classes, autoshape):
    ...
    #config = os.path.join("visionlab_stack","detection","yolov5","models","hub",f"{name}.yaml")
    try:
